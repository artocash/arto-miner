...
// cryptonight_monero || cryptonight_aeon || cryptonight_arto || cryptonight_stellite || cryptonight_masari || cryptonight_bittube2
...
// cryptonight_arto || cryptonight_bittube2
#	if(ALGO == 6 || ALGO == 10)
			uint2 arto_tmp = tweak1_2 ^ ((uint2 *)&(a[0]))[0];
			((uint2 *)&(a[1]))[0] ^= arto_tmp;
