...
enum xmrstak_algo
{
	...
	cryptonight_heavy = 4,
	cryptonight_aeon = 5,
	cryptonight_arto = 6, // equal to cryptonight_monero with a small tweak in the miner code
...
template<>
inline constexpr size_t cn_select_memory<cryptonight_arto>() { return CRYPTONIGHT_MEMORY; }
...
template<>
inline constexpr uint32_t cn_select_mask<cryptonight_arto>() { return CRYPTONIGHT_MASK; }
...
template<>
inline constexpr uint32_t cn_select_iter<cryptonight_arto>() { return CRYPTONIGHT_ITER; }
