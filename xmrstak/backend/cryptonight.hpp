...
constexpr size_t CRYPTONIGHT_ARTO_MEMORY = 2 * 1024 * 1024;
constexpr uint32_t CRYPTONIGHT_ARTO_MASK = CRYPTONIGHT_ARTO_MEMORY - 16;
constexpr uint32_t CRYPTONIGHT_ARTO_ITER = CRYPTONIGHT_ARTO_MEMORY / 4;
