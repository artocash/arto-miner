...
bool minethd::self_test()
{
	...
	else if (::jconf::inst()->GetMiningAlgo() == cryptonight_arto)
	{
		unsigned char out[32 * MAX_N];
		cn_hash_fun hashf;
		//cn_hash_fun_multi hashf_multi;

		hashf = func_selector(::jconf::inst()->HaveHardwareAes(), false, xmrstak_algo::cryptonight_arto);
...
minethd::cn_hash_fun minethd::func_selector(bool bHaveAes, bool bNoPrefetch, xmrstak_algo algo)
{
	...
	static const cn_hash_fun func_table[] = {
		...
		cryptonight_hash<cryptonight_arto, false, false>,
		cryptonight_hash<cryptonight_arto, true, false>,
		cryptonight_hash<cryptonight_arto, false, true>,
		cryptonight_hash<cryptonight_arto, true, true>
	};
...
void minethd::work_main()
{
	...
	while (bQuit == 0)
	{
		...
		if (::jconf::inst()->GetMiningAlgo() == cryptonight_arto) new_version = oWork.bWorkBlob[1];
...
minethd::cn_hash_fun_multi minethd::func_multi_selector(size_t N, bool bHaveAes, bool bNoPrefetch, xmrstak_algo algo)
{
	...
	static const cn_hash_fun_multi func_table[] = {
		...
		cryptonight_double_hash<cryptonight_arto, false, false>,
		cryptonight_double_hash<cryptonight_arto, true, false>,
		cryptonight_double_hash<cryptonight_arto, false, true>,
		cryptonight_double_hash<cryptonight_arto, true, true>,
		cryptonight_triple_hash<cryptonight_arto, false, false>,
		cryptonight_triple_hash<cryptonight_arto, true, false>,
		cryptonight_triple_hash<cryptonight_arto, false, true>,
		cryptonight_triple_hash<cryptonight_arto, true, true>,
		cryptonight_quad_hash<cryptonight_arto, false, false>,
		cryptonight_quad_hash<cryptonight_arto, true, false>,
		cryptonight_quad_hash<cryptonight_arto, false, true>,
		cryptonight_quad_hash<cryptonight_arto, true, true>,
		cryptonight_penta_hash<cryptonight_arto, false, false>,
		cryptonight_penta_hash<cryptonight_arto, true, false>,
		cryptonight_penta_hash<cryptonight_arto, false, true>,
		cryptonight_penta_hash<cryptonight_arto, true, true>
	};
