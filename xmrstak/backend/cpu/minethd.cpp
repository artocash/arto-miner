...
minethd::cn_hash_fun minethd::func_multi_selector(bool bHaveAes, bool bNoPrefetch, xmrstak_algo algo, const std::string& asm_version_str)
{
	...
	static const cn_hash_fun func_table[] = {
		...
		Cryptonight_hash<N>::template hash<cryptonight_arto, false, false>,
		Cryptonight_hash<N>::template hash<cryptonight_arto, true, false>,
		Cryptonight_hash<N>::template hash<cryptonight_arto, false, true>,
		Cryptonight_hash<N>::template hash<cryptonight_arto, true, true>,
