...
void cryptonight_hash(const void* input, size_t len, void* output, cryptonight_ctx* ctx0)
{
	...
	if((ALGO == cryptonight_monero || ALGO == cryptonight_aeon || ALGO == cryptonight_arto) && len < 43)
	{
		memset(output, 0, 32);
		return;
	}
	...
	if(ALGO == cryptonight_monero || ALGO == cryptonight_aeon || ALGO == cryptonight_arto)
	{
